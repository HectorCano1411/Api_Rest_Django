...
SECRET_KEY = 'django-insecure-(*rcrj%n$46p7qk2e8qo*z0$^=qi$-0+s3wftok*@7s_51%=p)'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # Agrega aquí otros métodos de autenticación si es necesario
    ],
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticated',
        # También puedes agregar aquí otros permisos predeterminados si es necesario
    ],
}
...
#     'root': {
#         'handlers': ['console'],
#         'level': 'DEBUG',  # Cambiado a DEBUG para mostrar mensajes de este nivel
#     },
#     'loggers': {
#         'django': {
#             'handlers': ['console'],
#             'level': 'DEBUG',  # Configura el nivel de log de Django
#             'propagate': True,
#         },
#     },
# }
